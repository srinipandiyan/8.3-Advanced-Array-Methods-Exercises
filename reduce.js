...
function vowelCount(str) {
    ...
    let vowels = "aeiou";
    return strArray.reduce(function(accumulator, char){
        let charLowerCase = char.toLowerCase();
        if (vowels.indexOf(charLowerCase) !== -1){
            if(accumulator[charLowerCase]){
                accumulator[charLowerCase]+= 1;
            } else {
                accumulator[charLowerCase] = 1;
            }
        }
...
function addKeyAndValue(arr, key, value) {
    return arr.reduce(function(accumulator, currentVal, i){
